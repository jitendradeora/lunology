    ...
    <section className="relative min-h-screen flex items-center overflow-hidden py-24 sm:py-20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className={`space-y-6 sm:space-y-8 text-center order-2 lg:order-1 ${language === 'ar' ? 'lg:text-right' : 'lg:text-left'}`}>
            <motion.div
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mb-4 sm:mb-6" style={{ fontFamily: 'var(--font-heading)' }}>
                {t('hero.title')}
              </h1>

              <p className={`text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-8 sm:mb-12 leading-relaxed max-w-2xl mx-auto ${language === 'ar' ? 'lg:mr-0 lg:ml-auto' : 'lg:mx-0'}`}>
                {t('hero.tagline')}
              </p>

              <div className={`flex justify-center ${language === 'ar' ? 'lg:justify-end' : 'lg:justify-start'}`}>
                <Link
                  to="/shop"
          ...
          <div className="relative flex items-center justify-center lg:justify-end pointer-events-none h-[400px] sm:h-[500px] lg:h-[600px] order-1 lg:order-2">
            <motion.div
          ...
          <motion.div
            ...
            style={{
              borderColor: theme === 'dark' ? 'rgba(76, 85, 120, 0.4)' : 'rgba(120, 135, 170, 0.5)',
              borderWidth: '1px',
            }}
            animate={{
              rotate: [0, 360],
          ...
          <motion.div
            ...
            animate={{
              opacity: theme === 'dark' ? [0.3, 0.4, 0.3] : [0.7, 0.85, 0.7],
            }}
            transition={{
              duration: 6,
              repeat: Infinity,
          ...
          />
              ...
              <div
                ...
                style={{
                  backgroundColor: theme === 'dark' ? 'rgba(76, 85, 120, 0.15)' : 'rgba(120, 140, 170, 0.45)',
                  boxShadow: theme === 'dark' ? 'none' : 'inset 0 2px 8px rgba(100, 120, 150, 0.3)',
                }}
              ></div>
              <div
                className="absolute top-1/2 right-1/3 w-8 h-8 rounded-full blur-sm"
                style={{
                  backgroundColor: theme === 'dark' ? 'rgba(76, 85, 120, 0.15)' : 'rgba(130, 150, 180, 0.4)',
                  boxShadow: theme === 'dark' ? 'none' : 'inset 0 2px 6px rgba(100, 120, 150, 0.25)',
                }}
              ></div>
              <div
                className="absolute bottom-1/3 left-1/2 w-10 h-10 rounded-full blur-sm"
                style={{
                  backgroundColor: theme === 'dark' ? 'rgba(76, 85, 120, 0.15)' : 'rgba(125, 145, 175, 0.42)',
                  boxShadow: theme === 'dark' ? 'none' : 'inset 0 2px 7px rgba(100, 120, 150, 0.28)',
                }}
              ></div>
