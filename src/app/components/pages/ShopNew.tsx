              ...
              >
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="px-4 py-2 bg-muted border-2 border-transparent rounded-xl hover:border-primary transition-colors text-sm cursor-pointer select-custom appearance-none"
                    aria-label={
                      language === "ar" ? "ترتيب المنتجات" : "Sort products"
                    }
                  >
                  ...
                  >
                    <Link to={`/product/${product.id}`} className="group block">
                      ...
                      <div className="space-y-1">
                        ...
                        <h3
                          className="text-sm md:text-base group-hover:text-primary transition-colors line-clamp-1"
                          style={{ fontFamily: "var(--font-heading)" }}
                        >
                          {language === "ar" ? product.nameAr : product.name}
                        </h3>
