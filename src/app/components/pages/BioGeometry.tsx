...
import { SEO } from '../SEO';
import { Hexagon, Waves, Zap, Shield } from 'lucide-react';
...
export function BioGeometry() {
  ...
  const principles = [
    {
      ...
      descriptionEn: 'Ancient geometric patterns that carry universal energy and harmony. These shapes resonate with the fundamental structure of creation.',
      descriptionAr: 'الأنماط الهندسية القديمة التي تحمل الطاقة والانسجام الكوني. هذه الأشكال تتردد مع البنية الأساسية للخلق.'
    },
    {
      icon: Waves,
      titleEn: 'Energy Balancing',
      titleAr: 'توازن الطاقة',
      descriptionEn: 'Harmonizing the subtle energies in our environment and within ourselves for optimal wellbeing and spiritual clarity.',
      descriptionAr: 'مواءمة الطاقات الدقيقة في بيئتنا وداخل أنفسنا لتحقيق الرفاهية المثلى والوضوح الروحي.'
    },
    {
      icon: Zap,
      titleEn: 'Vibrational Resonance',
      titleAr: 'الرنين الاهتزازي',
      descriptionEn: 'Understanding how shapes, colors, and patterns influence our energetic field and consciousness through resonance.',
      descriptionAr: 'فهم كيف تؤثر الأشكال والألوان والأنماط على مجالنا الطاقي والوعي من خلال الرنين.'
    },
    {
      icon: Shield,
      titleEn: 'Environmental Harmony',
      titleAr: 'الانسجام البيئي',
      descriptionEn: 'Creating balanced spaces that support health, creativity, and spiritual growth through conscious design.',
      descriptionAr: 'خلق مساحات متوازنة تدعم الصحة والإبداع والنمو الروحي من خلال التصميم الواعي.'
    }
  ];
  ...
  return (
    <>
      <SEO
        title={language === 'ar' ? 'الهندسة الحيوية - لونولوجي' : 'BioGeometry - Lunology'}
        description={language === 'ar' ? 'اكتشف علم الهندسة الحيوية وكيف تؤثر الأشكال والأنماط الهندسية على طاقتنا ورفاهيتنا' : 'Discover the science of BioGeometry and how geometric shapes and patterns affect our energy and wellbeing'}
      ...
      <div className="pt-20 min-h-screen">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-4xl text-center" style={{ fontFamily: 'var(--font-heading)' }}>
                {language === 'ar' ? 'ما هي الهندسة الحيوية؟' : 'What is BioGeometry?'}
              </h2>
        ...
        <section className="py-16 px-4 bg-muted/30">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-4xl text-center" style={{ fontFamily: 'var(--font-heading)' }}>
                {language === 'ar' ? 'التطبيقات العملية' : 'Practical Applications'}
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 rounded-xl bg-background/50 border border-border">
                  <h3 className="text-xl mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
                    {language === 'ar' ? 'الشفاء البيئي' : 'Environmental Healing'}
                  </h3>
                  <p className="text-muted-foreground leading-relaxed">
                    {language === 'ar'
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-3xl" style={{ fontFamily: 'var(--font-heading)' }}>
                {language === 'ar' ? 'انسجام من خلال التصميم' : 'Harmony Through Design'}
              </h2>
